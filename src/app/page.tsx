...
const games: GameDef[] = [
  ...
  { id: 'anime-grid', title: 'One Piece Tic Tac Toe', description: 'Completa el grid 3x3 con personajes que cumplan las condiciones', icon: Target, difficulty: 'Hard', players: '1 Player', time: '5-15 min', status: 'available', href: '/games/anime-grid', color: 'from-cyan-500 to-teal-500' },
